...
void Tema3::LoadObstacles(float time) {
	...
	obstacesPos[0] = modelMatrix * glm::vec4(0.f, 0.f, 0.f, 1.f);
	...
	modelMatrix *= Transform3D::Scale(1.95f, 0.65f, 0.35f);
	obstacesPos[1] = modelMatrix * glm::vec4(0.f, 0.f, 0.f, 1.f);
...
void Tema3::LoadCollectionItem(float time) {
	if (start == true && fallingPlayer == false) {
		translateCollectionItem += 7.5f * time;
	}
	
	glm::mat4 modelMatrix = glm::mat4(1);
	modelMatrix *= Transform3D::Translate(-2.65f, 0.75f, -8.25f + translateCollectionItem);
