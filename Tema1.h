...
class Tema1 : public SimpleScene {
	...
	private:
		...
		void LoadStars();
		void LoadWindingBallons(float deltaTime);
	...
	protected:
		...
		int livesCount = 10; //numarul de vieti al jucatorului
		...
		std::vector<glm::vec2> windingBallons = std::vector<glm::vec2>(40); //pozitiile baloanelor care se misca pe un traseu serpuitor
		//retine daca s-au produs coliziuni intre baloanele care se misca serpuit si sageata
